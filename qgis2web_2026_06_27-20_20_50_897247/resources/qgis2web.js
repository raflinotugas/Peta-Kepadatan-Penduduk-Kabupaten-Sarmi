...
map.getView().fit([15352610.258403, -409298.045434, 15624807.339124, -168008.971590], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Klasifikasi Jumlah Penduduk Kabupaten Sarmi</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (97 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini memberikan informasi tentang kepadatan penduduk di Kabupaten Sarmi dalam pada tahun 2025';
            }
